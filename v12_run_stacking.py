...
run_stacking.py
---------------
Post-Phase-A stacking pipeline for v12.
...
Picks up from already-saved Phase A checkpoints and executes:
  ...
  Phase C   – LightGBM meta-learner with custom Focal Loss (γ=2.0, colsample=0.6)
  Output    – submission_v12_stacking.csv
...
def main():
    ...
    logger.log("=" * 70)
    logger.log("  run_stacking.py – v12 Phase B+C from saved Phase A checkpoints")
    ...
    # ════════════════════════════════════════════════════════════════════════
    # PHASE C : Meta-feature assembly + LightGBM stacking
    # ════════════════════════════════════════════════════════════════════════
    logger.log(f"\n══ PHASE C: Meta-Feature Assembly + LightGBM ══")
